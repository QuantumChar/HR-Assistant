...
(hr-assistant-build-guide.md). It intentionally does NOT crawl websites —
...
Optional: AZURE_SEARCH_INDEX (default "hr-knowledge"),
...
INDEX_NAME = os.environ.get("AZURE_SEARCH_INDEX", "hr-knowledge")
